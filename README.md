...
This is a very elementary version of the OVapp, offering basic functionality: How to travel from A to B at a certain
date&time, using some mode of transportation (bus, tram, train, plane, ...)
On purpose, *No attention* has been paid to UI aspects.
...
```
cd existing_repo
git remote add origin https://gitlab.com/adsd-hu/ovapp-intro.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/adsd-hu/ovapp-intro/-/settings/integrations)
